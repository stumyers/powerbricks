...
LIBS=-lrt -lpthread -lpthread_rt -lxenomai -ldl -lppmac
endif
ifneq ($(ARCH),powerpc)
LIBS=-lrt -lpthread -ldl -lppmac -lmath -L$(LIBMATHDIR)
endif
ifneq ($(PMAC_ARCH),i386hv)
...
LDFLAGS = $(LIBS) --sysroot=$(ROOTFS_DIR) \
 \
-L../../../Bin/Release/ \
-L$(XENOMAI_LIB_DIR) -L$(LIBPPMACINCLUDEDIR) -L$(RTPMACINCLUDEDIR) -L$(LIB_DIR) \
-Wl,-rpath,/var/ftp/usrflash/Project/C\ Language/Libraries \
-Wl,-rpath,/var/ftp/usrflash/Project/Bin/Release \
...
gather_server.c
OBJS = $(SRCS:.c=.o)
PROG = "../../../Bin/Release/gather_server.out"
...
depend:
	$(RM) ../../../Bin/Release/dependency.lst
	makedepend -f- -- $(CFLAGS) -- $(SRCS) > ../../../Bin/Release/dependency.lst
