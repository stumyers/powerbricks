...
depend:
	$(RM) ../../Bin/Release/dependencyko.lst
	makedepend -f- -- $(CFLAGS) -- $(SRCS) > ../Bin/Release/dependencyko.lst

#ifneq ($(MAKECMDGOALS),depend)
#include ../Bin/Release/dependencyko.lst
#endif
